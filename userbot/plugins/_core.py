...
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else "KIBGBOT"
...
async def unload(event):
    ...
    try:
        ...
        qwe = await eor(event, f"KINGBOT PLUG Has Successfully unloaded {shortname}")
    except Exception as e:
        await qwe.edit(
            "KINGBOT PLUG has Successfully unloaded {shortname}\n{}".format(shortname, str(e))
        )
